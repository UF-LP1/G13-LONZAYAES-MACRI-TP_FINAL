...
cHospital::cHospital(string _Nombre, string _Direccion, const unsigned int _Num_identificacion, cListas <cMedico>& _Lista_Medicos, cListas<cOrtopedia>&_lista_ortopedias) :Num_identificacion(_Num_identificacion)
